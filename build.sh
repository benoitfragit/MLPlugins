...
LIBBRAIN_NAME=MLP
LIBBRAIN_DESCRIPTION="Multi-Layer-Perceptron written in C for learning purpose"
...
LIBBRAIN_INSTALL_DIR=$LIBBRAIN_ROOT_DIR/install/$LIBBRAIN_BUILD_TYPE/libbrain-$LIBBRAIN_VERSION
