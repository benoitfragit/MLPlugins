...
LIBBRAIN_INSTALL_DIR=$LIBBRAIN_ROOT_DIR/install/$LIBBRAIN_BUILD_TYPE/libbrain-$LIBBRAIN_VERSION_MAJOR.$LIBBRAIN_VERSION_MINOR.$LIBBRAIN_PATCH_VERSION
...
cmake -DCMAKE_BUILD_TYPE=$LIBBRAIN_BUILD_TYPE           \
      ...
      -DLIBBRAIN_VERSION_PATCH=$LIBBRAIN_PATCH_VERSION  \
