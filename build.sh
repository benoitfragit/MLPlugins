...
LIBBRAIN_AUTHOR=benoitfragit
LIBBRAIN_NAME=MLP
LIBBRAIN_DESCRIPTION="MLPlugins developed by Benoitfragit"
LIBBRAIN_VERSION=$LIBBRAIN_VERSION_MAJOR.$LIBBRAIN_VERSION_MINOR.$LIBBRAIN_VERSION_PATCH
LIBBRAIN_BUILD_DIR=$LIBBRAIN_ROOT_DIR/build/$LIBBRAIN_BUILD_TYPE/mlplugins
LIBBRAIN_INSTALL_DIR=$LIBBRAIN_ROOT_DIR/install/$LIBBRAIN_BUILD_TYPE/mlplugins-$LIBBRAIN_VERSION
