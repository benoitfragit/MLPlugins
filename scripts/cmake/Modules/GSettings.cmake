...
macro (add_schema SCHEMA_NAME OUTPUT)
    ...
    execute_process (COMMAND ${_glib_comple_schemas} --dry-run --schema-file=${CMAKE_CURRENT_SOURCE_DIR}/resources/${SCHEMA_NAME} ERROR_VARIABLE _schemas_invalid OUTPUT_STRIP_TRAILING_WHITESPACE)
    ...
    if (GSETTINGS_LOCALCOMPILE)
        ...
        add_custom_command(
            ...
            DEPENDS
                "${PROJECT_SOURCE_DIR}/resources/${SCHEMA_NAME}"
            VERBATIM
        )
    ...
    install (FILES ${CMAKE_CURRENT_SOURCE_DIR}/resources/${SCHEMA_NAME} DESTINATION ${GSETTINGS_DIR} OPTIONAL)
